...
[Карточки (/api/card/*)](./doc/cards.md)

[Шаблоны карточек (/api/templates/*)](./doc/templates.md)
...
Как Вы можете заметить, дизайн позволяет задавать переменные параметры, они отрисовываются синими плейсхолдерами.
